...
myApp.directive('mwlCalendarMonth', function ($sce, $timeout, $filter, moment, calendarHelper) {
    return {
      templateUrl: './bower_components/angular-bootstrap-calendar/templates/month.html',
      restrict: 'EA',
      require: '^mwlCalendar',
      scope: {
